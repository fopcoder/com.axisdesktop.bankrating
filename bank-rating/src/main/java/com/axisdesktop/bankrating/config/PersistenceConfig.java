...
@EnableJpaRepositories( "com.axisdesktop.bankrating.repository" )
public class PersistenceConfig {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
		...
		factory.setPackagesToScan( "com.axisdesktop.bankrating.entity" );
		factory.setDataSource( dataSource() );
		factory.setPersistenceUnitName( "bankrating-jndi" );
